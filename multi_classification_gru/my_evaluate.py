...
predicts = out.iloc[:,1]
y = test.iloc[:,3]
precision = metrics.precision_score(y, predicts,average='micro')
recall = metrics.recall_score(y, predicts,average='micro')
f1 = metrics.f1_score(y, predicts,average='micro')
